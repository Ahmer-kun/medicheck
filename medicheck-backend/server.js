...
// NOTE: 404 handler moved to after all blockchain routes below.
// Express matches routes in order — if 404 is here, it catches
// /api/blockchain/real/status and /api/blockchain/real/health
// before those route handlers are reached.
...
// ✅ 404 handler — MUST be last, after ALL route definitions
app.use('*', (req, res) => {
  res.status(404).json({
    success: false,
