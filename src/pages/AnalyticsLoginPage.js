        ...
        <div className="bg-white p-8 rounded-2xl border border-gray-200 shadow-lg w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 bg-teal-600 text-white rounded-xl font-semibold hover:bg-teal-700 transition-all duration-300 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed shadow-md"
            >
              {loading ? 'Signing In...' : 'Access Analytics Portal'}
            </button>
          </form>

          <div className="mt-6 text-center text-gray-600 text-sm">
            <p>Demo Credentials:</p>
            <p>Username: <strong>analytics</strong></p>
            <p>Password: <strong>analytics123</strong></p>
          </div>
        </div>
      </div>
    </BackgroundFix>
