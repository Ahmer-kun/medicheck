      ...
      <div className="min-h-screen flex items-center justify-center p-4">
        <div className="bg-white p-8 rounded-2xl border border-gray-200 shadow-lg w-full max-w-md">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-gray-800 mb-2">Viewer Login</h1>
            <p className="text-gray-600">Quality Checking Portal</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 bg-orange-600 text-white rounded-xl font-semibold hover:bg-orange-700 transition-all duration-300 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed shadow-md"
            >
              {loading ? 'Signing In...' : 'Access Viewer Portal'}
            </button>
          </form>

          <div className="mt-6 text-center text-gray-600 text-sm">
            <p>Demo Credentials:</p>
            <p>Username: <strong>viewer</strong></p>
            <p>Password: <strong>view123</strong></p>
          </div>
        </div>
      </div>
    </BackgroundFix>
