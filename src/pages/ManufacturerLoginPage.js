      ...
      <div className="min-h-screen flex items-center justify-center p-4">
        <div className="bg-white p-8 rounded-2xl border border-gray-200 shadow-lg w-full max-w-md">
          ...
          <div className="mt-6 text-center text-gray-600 text-sm">
            ...
            <p>Username: <strong>manufacturer</strong></p>
            <p>Password: <strong>manu123</strong></p>
          </div>
        </div>
      </div>
    </BackgroundFix>
...
//               type="submit"
//               disabled={loading}
//               className="w-full py-3 bg-purple-600 text-white rounded-xl font-semibold hover:bg-purple-700 transition-all duration-300 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed shadow-md"
//             >
