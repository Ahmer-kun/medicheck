...
// // pages/RoleSelectionPage.js - Updated with back button
// import React, { useState, useEffect } from "react";
// import BackgroundFix from "../components/BackgroundFix";
// import { THEMES } from "../data/themes";
// import { useNavigate } from "react-router-dom"; // NEW: Add this import
...
//   // NEW: Function to go back to landing page
//   const handleBackToLanding = () => {
//     navigate("/");
//   };
...
//             <button
//               onClick={handleBackToLanding}
//               className="mb-6 text-slate-300 hover:text-white transition-colors flex items-center gap-2 text-sm bg-slate-800/30 backdrop-blur-sm px-4 py-2 rounded-full border border-slate-700/30 hover:border-slate-600/50"
//             >
//               <span>←</span>
//               <span>Back to Home</span>
//             </button>
...
//               <div className="absolute -inset-1 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 rounded-lg blur opacity-30 animate-pulse"></div>
//               <h1 className="relative text-5xl md:text-7xl font-black tracking-tighter bg-clip-text text-transparent bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 animate-gradient-x text-center block">
//                 MEDICHECK
//               </h1>
//             </div>

//             {/* Subtitle */}
//             <p className="text-lg md:text-xl text-slate-300 mb-12 font-light tracking-wide text-center">
