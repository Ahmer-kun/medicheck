...
function ManufacturerLoginPage({ onLogin, onBack }) {
  ...
  const handleContactSupport = () => {
    ...
    const body = encodeURIComponent(
      ...
      `• Manufacturing License No.: [If Applicable]\n` +
      ...
      `We agree to comply with all regulatory requirements.\n\n` +
      `Best regards,\n` +
      `[Your Name]\n` +
      `[Your Title]\n` +
      `[Manufacturer Name]`
        ...
        <div className="bg-white rounded-2xl border border-gray-200 shadow-lg w-full max-w-4xl overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-purple-500 to-purple-600 p-8 text-white">
            ...
            <div className="flex items-center gap-6">
              ...
              <div>
                <h1 className="text-3xl font-bold mb-2">Manufacturer Login</h1>
                <p className="text-purple-100">Medicine production and batch registration</p>
                <p className="text-purple-200 text-sm mt-1">Production • Quality • Blockchain Registration</p>
              </div>
            </div>
          </div>
          ...
          <div className="p-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              {/* Login Form */}
              <div>
                <h2 className="text-xl font-semibold text-gray-800 mb-6">Production Portal Access</h2>
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full p-3 border-2 rounded-xl placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-purple-500/20 transition ${
                        errors.username ? 'border-red-300 bg-red-50' : 'border-gray-300 bg-gray-50 focus:border-purple-500'
                      }`}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full p-3 border-2 rounded-xl placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-purple-500/20 transition ${
                        errors.password ? 'border-red-300 bg-red-50' : 'border-gray-300 bg-gray-50 focus:border-purple-500'
                      }`}
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full py-3 bg-gradient-to-r from-purple-500 to-purple-600 text-white rounded-xl font-semibold hover:from-purple-600 hover:to-purple-700 transition-all duration-300 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed shadow-md flex items-center justify-center gap-2"
                  >
                    {loading ? (
                      <>
                ...
                <div className="mt-6 p-4 bg-purple-50 rounded-xl border border-purple-200">
                  <p className="text-purple-800 text-sm mb-2">Don't have manufacturer access?</p>
                  <button
                    onClick={handleContactSupport}
                    className="w-full py-2 bg-white text-purple-600 border border-purple-300 rounded-lg font-semibold hover:bg-purple-50 transition-colors"
                  >
                    Request Manufacturing Access
                  </button>
                </div>
              </div>
              ...
              <div>
                <div className="bg-gradient-to-br from-purple-50 to-purple-100 p-6 rounded-2xl border border-purple-200">
                  <h3 className="text-xl font-semibold text-gray-800 mb-6">Manufacturing Capabilities</h3>
                  
                  <div className="space-y-4">
                    <div className="flex items-start gap-3 p-4 bg-white rounded-xl border border-purple-200">
                      <div className="text-purple-600 text-lg">📦</div>
                      <div>
                        <h4 className="font-semibold text-gray-800 mb-1">Batch Creation</h4>
                        <p className="text-gray-600 text-sm">Create and register medicine batches with complete production details</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3 p-4 bg-white rounded-xl border border-purple-200">
                      <div className="text-purple-600 text-lg">🔗</div>
                      <div>
                        <h4 className="font-semibold text-gray-800 mb-1">Blockchain Registration</h4>
                        <p className="text-gray-600 text-sm">Register batches on blockchain for immutable tracking and verification</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3 p-4 bg-white rounded-xl border border-purple-200">
                      <div className="text-purple-600 text-lg">📊</div>
                      <div>
                        <h4 className="font-semibold text-gray-800 mb-1">Production Analytics</h4>
                        <p className="text-gray-600 text-sm">Monitor production statistics and batch performance metrics</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3 p-4 bg-white rounded-xl border border-purple-200">
                      <div className="text-purple-600 text-lg">🏭</div>
                      <div>
                        <h4 className="font-semibold text-gray-800 mb-1">Multi-plant Management</h4>
                        <p className="text-gray-600 text-sm">Manage multiple manufacturing facilities from single dashboard</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="mt-6 pt-4 border-t border-purple-200">
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <span className="font-medium text-gray-800">Manufacturing Support</span>
                    </div>
                    <p className="text-gray-700 text-sm mb-3">
                      For production access, batch permissions, or technical issues:
                    </p>
                    <div className="text-center font-mono text-sm bg-white text-purple-800 p-2 rounded-lg border border-purple-300">
            ...
            <div className="mt-8 p-4 bg-gradient-to-r from-purple-50 to-purple-100 rounded-xl border border-purple-200">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-semibold text-purple-800">Compliance Notice</p>
