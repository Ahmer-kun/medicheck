...
function ContactPage() {
  ...
  const contactInfo = [
    { title: "General Inquiries", email: "contact.medicheck@gmail.com", description: "For general questions and information" },
    { title: "Technical Support", email: "contact.medicheck@gmail.com", description: "Technical issues and product support" },
    { title: "Business Partnerships", email: "contact.medicheck@gmail.com", description: "Collaboration and partnership opportunities" },
    { title: "Account Assistance", email: "contact.medicheck@gmail.com", description: "Help with account creation and access" }
  ];

  // FAQ items for accordion
  const faqItems = [
    { question: "How quickly can I get started?", answer: "You can start immediately by creating an account. Basic access is available instantly after registration." },
    { question: "Do you offer enterprise solutions?", answer: "Yes, we provide customized enterprise solutions based on your specific needs and scale requirements." },
    { question: "What is the setup process?", answer: "Standard setup takes 1-2 weeks. We provide complete documentation and support throughout the process." },
    { question: "Is training provided?", answer: "Yes, comprehensive training materials and sessions are included for all account types." },
    { question: "Can I integrate Medicheck with my existing systems?", answer: "Absolutely. We offer API integration with major ERP, inventory, and pharmacy management systems." },
    { question: "How do I get technical support?", answer: "Email contact.medicheck@gmail.com – our team typically responds within 24 hours on business days." }
  ];
          ...
          <div className="container mx-auto px-4 py-4 max-w-7xl">
            <div className="flex items-center justify-between">
              ...
              <div className="hidden md:flex items-center gap-6">
                ...
                <button className="text-cyan-400 font-medium">Contact</button>
              </div>
            ...
            <div className="md:hidden bg-gray-900/95 backdrop-blur-md border-t border-white/5">
              <div className="container mx-auto px-4 py-4">
                <div className="flex flex-col gap-3">
                  ...
                  <button className="text-cyan-400 font-medium text-left py-2">Contact</button>
                </div>
              </div>
            </div>
          )}
        ...
        <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 px-4 w-full">
          ...
          <div className="container mx-auto relative z-10 max-w-4xl text-center">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-white mb-6 leading-tight">
              Contact <span className="bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">Medicheck</span>
            </h1>
          ...
          <div className="container mx-auto max-w-7xl">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div className="bg-gray-800/60 backdrop-blur-md rounded-2xl p-8 border border-white/5 shadow-xl">
                ...
                <p className="text-slate-300 mb-6">Fill out the form below and we'll get back to you within 24 hours.</p>

                {submitted ? (
                  <div className="text-center py-12">
                    <div className="text-6xl mb-4">✅</div>
                    <h3 className="text-2xl font-bold text-white mb-2">Message Sent!</h3>
                    <p className="text-slate-300 mb-6">Thank you for contacting Medicheck. We'll be in touch shortly.</p>
                    <button
                      onClick={() => setSubmitted(false)}
                      className="bg-white text-blue-900 px-6 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-all"
                    >
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-4 py-3 bg-gray-900/50 border border-white/10 rounded-lg text-white placeholder-slate-500 focus:border-cyan-500 focus:ring-2 focus:ring-cyan-400/20 transition"
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full px-4 py-3 bg-gray-900/50 border border-white/10 rounded-lg text-white focus:border-cyan-500 focus:ring-2 focus:ring-cyan-400/20 transition"
                      >
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                      <button
                        type="submit"
                        disabled={loading}
                        className="flex-1 bg-white text-blue-900 px-6 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-all disabled:opacity-50"
                      >
                        {loading ? (
              ...
              <div className="space-y-6">
                  ...
                  <div className="space-y-5">
                    {contactInfo.map((info, index) => (
                      <div key={index} className="flex items-start gap-4 p-4 bg-gray-900/40 rounded-xl hover:bg-gray-900/60 transition-colors">
                        <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-blue-500 to-cyan-500 flex items-center justify-center text-white text-sm font-bold flex-shrink-0">
                          {info.title.charAt(0)}
                        </div>
                        <div className="flex-1 min-w-0">
                          ...
                          <a href={`mailto:${info.email}`} className="text-cyan-400 hover:text-cyan-300 text-sm break-all">
                            {info.email}
                          </a>
                        </div>
                      </div>
                ...
                <div className="bg-gradient-to-br from-blue-900/40 to-cyan-900/40 backdrop-blur-md rounded-2xl p-8 border border-white/5">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-slate-300 text-sm">Global team, 24/7 support</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-blue-500 to-cyan-500 flex items-center justify-center text-white text-sm">⌚</div>
                      <div>
                        ...
                        <p className="text-slate-300 text-sm">Within 24 hours (Mon–Fri)</p>
                      </div>
                    </div>
                    <div className="pt-4 border-t border-white/5">
                      <p className="text-slate-200 text-sm">Primary contact:</p>
                      <a href="mailto:contact.medicheck@gmail.com" className="text-cyan-400 font-medium break-all">contact.medicheck@gmail.com</a>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <section className="py-20 px-4 bg-gray-900/40 w-full">
          <div className="container mx-auto max-w-4xl">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-slate-300">Quick answers to frequently asked questions</p>
            </div>
            <div className="space-y-4">
              {faqItems.map((faq, index) => (
                <div key={index} className="bg-gray-800/60 backdrop-blur-md rounded-xl border border-white/5 overflow-hidden">
                  <button
                  ...
                  >
                    ...
                    <svg className={`w-5 h-5 text-slate-300 transition-transform duration-300 ${openFaq === index ? "rotate-180" : ""}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="text-center mt-8">
              <p className="text-slate-300 mb-2">Don't see your question?</p>
              <button
                onClick={() => {
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              ...
              <div>
                ...
                <ul className="space-y-2 text-slate-400 text-sm">
                  ...
                  <li><button className="text-cyan-400 text-left">Contact</button></li>
                </ul>
              </div>
              <div>
                <h4 className="text-lg font-bold mb-4 text-slate-200">Quick Links</h4>
                <ul className="space-y-2 text-slate-400 text-sm">
                  <li>Get Started</li>
                  <li>Documentation</li>
