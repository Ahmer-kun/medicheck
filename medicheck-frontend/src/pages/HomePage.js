      ...
      <div className="min-h-screen w-full overflow-x-hidden bg-[#0B0E14] text-white font-sans">
        ...
        <nav
          className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
            isScrolled
              ? "bg-gray-900/85 backdrop-blur-xl shadow-xl border-b border-white/5"
              : "bg-transparent"
          }`}
        >
              ...
              <div className="container mx-auto px-4 py-4">
                <div className="flex flex-col gap-3">
                  <button
                    ...
                    className="text-cyan-400 font-medium text-left py-2"
                  >
                    Home
                  </button>
                  <button
                    onClick={() => handleNavClick("how-it-works")}
                    className="text-slate-300 hover:text-cyan-400 font-medium text-left py-2"
                  >
                    How It Works
                  </button>
                  <button
        ...
        {/* Hero Section – text left, dashboard right */}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <button
                    onClick={handleGetStarted}
                    className="bg-white text-blue-900 px-8 py-4 rounded-xl font-semibold text-lg hover:bg-gray-100 transition-all transform hover:scale-105 shadow-xl flex items-center justify-center gap-3 focus:ring-2 focus:ring-cyan-400"
                  >
                    <span>🚀</span> Start Tracking Now
                  </button>
                  <button
                    onClick={() => scrollToSection("features")}
                    className="bg-gray-800/70 backdrop-blur-md border border-white/10 text-slate-200 px-8 py-4 rounded-xl font-semibold text-lg hover:bg-gray-700 transition-all"
                  >
                    Explore Features
                  </button>
                </div>
                <div className="mt-8 flex flex-wrap items-center gap-4 text-slate-400 text-sm">
                  <div className="flex items-center gap-2"><div className="w-2 h-2 bg-emerald-400 rounded-full" /> Real-time Tracking</div>
                  <div className="flex items-center gap-2"><div className="w-2 h-2 bg-blue-400 rounded-full" /> Blockchain Security</div>
                  <div className="flex items-center gap-2"><div className="w-2 h-2 bg-cyan-400 rounded-full" /> Regulatory Compliance</div>
                </div>
              </div>

              {/* Dashboard visual (right) */}
              <div className="relative">
                <div className="relative transform perspective-1000 rotate-y-2 rotate-x-2">
                  <div className="bg-gradient-to-br from-blue-900/30 to-cyan-900/30 rounded-3xl p-1 backdrop-blur-sm border border-white/10 shadow-2xl">
                    <div className="bg-gray-800/70 backdrop-blur-md rounded-2xl p-6 shadow-inner">
                      ...
                      <div className="grid grid-cols-2 gap-4 mb-6">
                        <div className="bg-blue-900/30 p-4 rounded-xl">
                          <div className="flex items-center justify-between">
                            <div>
                              <p className="text-xs text-slate-300">Total Batches</p>
                              <p className="text-2xl font-bold text-white font-mono tabular-nums">5,820</p>
                            </div>
                        ...
                        <div className="bg-green-900/30 p-4 rounded-xl">
                          <div className="flex items-center justify-between">
                            <div>
                              ...
                              <p className="text-2xl font-bold text-white font-mono tabular-nums">1,582</p>
                            </div>
                            <span className="text-2xl">✅</span>
                          </div>
                        </div>
                        <div className="bg-orange-900/30 p-4 rounded-xl">
                          <div className="flex items-center justify-between">
                            <div>
                              <p className="text-xs text-slate-300">Expiring</p>
                              <p className="text-2xl font-bold text-white font-mono tabular-nums">236</p>
                            </div>
                        ...
                        <div className="bg-purple-900/30 p-4 rounded-xl">
                          <div className="flex items-center justify-between">
                            <div>
                              ...
                              <p className="text-2xl font-bold text-white font-mono tabular-nums">98%</p>
                            </div>
                            <span className="text-2xl">📈</span>
                          </div>
                        </div>
                      </div>
                      <div className="bg-gradient-to-r from-blue-900/40 to-cyan-900/40 p-4 rounded-xl">
                        <p className="text-slate-200 font-medium">Live Blockchain Network</p>
                        <div className="flex items-center gap-2 mt-2">
                          <div className="flex-1 bg-gray-700 h-2 rounded-full overflow-hidden">
                            <div className="bg-gradient-to-r from-emerald-400 to-cyan-500 h-full rounded-full w-[85%]"></div>
                          </div>
                  ...
                  {/* Glow effect */}
                  <div className="absolute -inset-0.5 bg-gradient-to-r from-blue-500/20 to-cyan-500/20 blur-xl -z-10 rounded-3xl" />
                </div>
              </div>
            </div>
          </div>
        ...
        {/* Features Section – removed active indicator, added tilt/shine effect */}
        <section id="features" className="py-20 px-4 bg-gradient-to-b from-gray-900/30 to-blue-950/20 w-full">
          <div className="container mx-auto max-w-7xl">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">Powerful Analytics & Insights</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {features.map((feature, index) => (
                <div
                  ...
                  className={`group relative bg-gray-800/60 backdrop-blur-md rounded-2xl p-6 border transition-all duration-500 cursor-pointer transform-gpu hover:scale-[1.02] hover:-rotate-1 ${
                    activeFeature === index
                      ? "border-emerald-500/80 shadow-xl shadow-emerald-500/10"
                ...
                >
                  ...
                  <div className={`w-14 h-14 rounded-xl bg-gradient-to-br ${feature.color} flex items-center justify-center text-2xl text-white mb-6 shadow-lg`}>
                    {feature.icon}
                  </div>
        ...
        <section id="testimonials" className="py-20 px-4 bg-gray-900/40 w-full">
          <div className="container mx-auto max-w-7xl">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">Trusted by Industry Leaders</h2>
              <p className="text-lg text-slate-300 max-w-3xl mx-auto">See what industry professionals say about Medicheck.</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {testimonials.map((testimonial, index) => (
                <div key={index} className="relative bg-gray-800/60 backdrop-blur-md rounded-2xl p-8 border border-white/5 shadow-lg hover:shadow-xl transition-shadow group">
                  {/* Left accent border */}
        ...
        {/* Statistics + Supply Chain Performance */}
        <section id="stats" className="py-20 px-4 bg-gradient-to-br from-gray-900 to-blue-950/30 w-full">
          <div className="container mx-auto max-w-7xl">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">Key Metrics & Analytics Reports</h2>
              <p className="text-lg text-slate-300 max-w-3xl mx-auto">Gain insight into critical aspects of your medicine operations.</p>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
              {stats.map((stat, index) => (
                <div key={index} className="bg-gray-800/60 backdrop-blur-md rounded-2xl p-8 border border-white/5 shadow-lg text-center hover:shadow-xl transition-shadow">
                  <div className="text-5xl mb-4">{stat.icon}</div>
                  <div className="text-4xl font-bold text-white font-mono tabular-nums mb-2">{stat.value}</div>
                  <div className="text-slate-300 font-medium">{stat.label}</div>
                </div>
              ))}
            </div>
            <div className="mt-12 bg-gray-800/60 backdrop-blur-md rounded-2xl p-8 border border-white/5 shadow-lg">
              <h3 className="text-2xl font-bold text-white mb-6">Supply Chain Performance</h3>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="p-4 bg-blue-900/30 rounded-xl">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-slate-300">Manufacturing Efficiency</span>
                ...
                <div className="p-4 bg-green-900/30 rounded-xl">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-slate-300">Delivery Accuracy</span>
                    <span className="font-bold text-blue-400 font-mono">97%</span>
                  </div>
                  <div className="w-full bg-gray-700 rounded-full h-2">
                ...
                <div className="p-4 bg-purple-900/30 rounded-xl">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="font-bold text-purple-400 font-mono">98%</span>
                  </div>
                  <div className="w-full bg-gray-700 rounded-full h-2">
        ...
        {/* CTA Section */}
        <section className="py-20 px-4 relative bg-gradient-to-b from-gray-900 to-[#0F172A] w-full overflow-hidden">
          <div className="absolute inset-0 flex items-center justify-center opacity-20 pointer-events-none">
            <div className="w-[600px] h-[600px] bg-cyan-500 rounded-full blur-3xl" />
          </div>
          <div className="container mx-auto max-w-7xl text-center relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button
                onClick={handleGetStarted}
                className="bg-white text-blue-900 px-10 py-4 rounded-xl font-bold text-lg hover:bg-gray-100 transition-all transform hover:scale-105 shadow-2xl flex items-center justify-center gap-3 focus:ring-2 focus:ring-cyan-400"
              >
            ...
            <p className="mt-8 text-slate-400 text-sm">No credit card required • 30-day free trial • Full support included</p>
          </div>
        </section>

        {/* Footer – removed tagline */}
        <footer className="bg-gray-950 text-white py-12 px-4 w-full border-t border-white/5">
          <div className="container mx-auto max-w-7xl">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              ...
              <div>
                <h4 className="text-lg font-bold mb-4 text-slate-200">Industries</h4>
                <ul className="space-y-2 text-slate-400 text-sm">
